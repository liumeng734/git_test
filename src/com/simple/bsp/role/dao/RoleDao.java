...
public class RoleDao{
	...
	public Map<String, Object> getPageList(DataGridModel dgm, Role role){
		...
		sumSql.append("select count(1) from pub_roles where 1=1");
		
		//获取结果集
		String quSql = "select role_id as uid, role_id as roleId, role_name as roleName, role_desc as roleDesc, " +
				" enable as enable, is_sys as isSys from pub_roles where 1=1 ";
		...
		if(null != role.getRoleName() && !role.getRoleName().equals("")){
			...
			sumSql.append(" and role_name like '%").append(role.getRoleName()).append("%'");
		}
	...
	public int saveRole(Role role){
		String sql = "insert into pub_roles (role_id, role_name, role_desc, enable, is_sys) " +
					 "values (:roleId, :roleName, :roleDesc,  :enable, :isSys)";
	//	role
	...
	public int updateRole(Role role){
		String sql = "update pub_roles set role_name = :roleName, role_desc = :roleDesc, " +
