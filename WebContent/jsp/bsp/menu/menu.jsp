...
<html>
	...
	function editMenuNode(){
		...
		title.attr("value", "修改菜单");		//提示当前为修改页面
		mark.attr("value", "update");		//'update'为修改标志
		menuId.attr("value", sNode.id);		//设置menuId
		menuName.attr("value", sNode.name);	//设置menuName
		menuUrl.attr("value", sNode.title);	//设置menuUrl
		menuDesc.attr("value", sNode.mdesc);//设置菜单排列顺序
		openType.attr("value", sNode.otype);//设置菜单打开方式
	...
	<div id="content">
		<div style="position:absolute; z-index:0; background: #ffffff; border: 1px solid #808080; height:550px; width:350px; margin:0;">
