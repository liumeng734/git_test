...
<form id="sysParamQuForm" style="margin:0; text-align:center; font-size:12px">
	...
	<table style="width:98%; font-size:12px; border:0px solid #f0f0f0;">
		<tr>
			<td width="10%" align="left">参数编码：</td>
			<td width="28%" align="left"><input name="paramCode" style="width:200"></td>
			<td width="10%" align="left">参数名称：</td>
			<td width="28%" align="left"><input name="paramName" style="width:200"></td>
