...
<html>
	...
	<form id="authorityUpForm" method="post" style="margin:0;text-align: center;">
		<!-- 隐藏域 -->
		...
		<table style="width:100%; font-size:12px; border:0px solid #f0f0f0;">
			...
			<tr>
				<td colspan="2" align="center">
					...
					<a href="#" id="btn-add" onclick="updateAuthority();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
				</td>
			</tr>
		</table>
	</form>
